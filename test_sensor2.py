...
for subj in range(0,len(Admin.files)):
    ...
    if len(events)==3:                    
        epochs_temp = epochs['40hz']
        epochs_40 = tf1.fem_to_tesla(epochs_temp._data)
        chans = tf1.chan_select(np.mean(epochs_40,axis = 0),np.arange(50,1301,1),np.arange(1750,2501,1),95,1000,40,5) 
        epochs_40 = np.squeeze(np.mean(epochs_40[:,chans,:],axis = 1))
        epochs_temp = epochs['30hz']
        epochs_30 = tf1.fem_to_tesla(epochs_temp._data)
        epochs_30 = np.squeeze(np.mean(epochs_30[:,chans,:],axis = 1))
        epochs_temp = epochs['20hz']
        epochs_20 = tf1.fem_to_tesla(epochs_temp._data)
        epochs_20 = np.squeeze(np.mean(epochs_20[:,chans,:],axis = 1))
        del epochs_temp
        epdata = make_Epochs(Admin.files[subj],epochs_40,epochs_30,epochs_20,chans)
        del chans, epochs_20,epochs_30,epochs_40 
        wav40 = tf2.erp_wavelets(epdata.e40hz,(2,82),2,5,(500,1000))
        wav30 = tf2.erp_wavelets(epdata.e30hz,(2,82),2,5,(500,1000))
        wav20 = tf2.erp_wavelets(epdata.e20hz,(2,82),2,5,(500,1000))
        waveletdata = make_WavData(Admin.files[subj],wav40,wav30,wav20)    
        # save timef data
        np.save(savename+'_timef',waveletdata,allow_pickle = True)
        del waveletdata,wav40,wav30,wav20
#        subject_data = tfc.make_subj_data(name,Admin.datapath,Admin.savepath,chans)
        ##### BAND PASS FILTERING & PHASE BINNING #####
        # Phase-amp binning & modulation index
        # tests for coupling between theta and gamma, and delta-gamma
        # these routines bandpass filter the stc signal into low and high then estimate the 
        # instantaneous phase (low) and amplitude (high) of the data. 
        # amplitude is organised according to the phase that it matches, and sorted into bins of
        # 60 degrees between -180 and +180 degrees of the low frq phase. This is done separately for
        # theta-gamma, and delta-gamma, for both the stimulation period and the baseline period.
        #Stimulation period
        khdataTG40 = tf2.kldiv_spec_band(epdata.e40hz,60,200,False,(4,8),(32,48),1000,(1501,2601))
        khdataTG30 = tf2.kldiv_spec_band(epdata.e30hz,60,200,False,(4,8),(32,48),1000,(1501,2601))
        khdataTG20 = tf2.kldiv_spec_band(epdata.e20hz,60,200,False,(4,8),(32,48),1000,(1501,2601))
        khdataDG40 = tf2.kldiv_spec_band(epdata.e40hz,60,200,False,(1,4),(32,48),1000,(1501,2601))
        khdataDG30 = tf2.kldiv_spec_band(epdata.e30hz,60,200,False,(1,4),(32,48),1000,(1501,2601))
        khdataDG20 = tf2.kldiv_spec_band(epdata.e20hz,60,200,False,(1,4),(32,48),1000,(1501,2601))
        ...
        del khdataTG40,khdataTG30,khdataTG20,khdataDG40,khdataDG30,khdataDG20,stim_sensor_CFC
        #Baseline period
        khdataTG40 = tf2.kldiv_spec_band(epdata.e40hz,60,200,False,(4,8),(32,48),1000,(500,1500))
        khdataTG30 = tf2.kldiv_spec_band(epdata.e30hz,60,200,False,(4,8),(32,48),1000,(500,1500))
        khdataTG20 = tf2.kldiv_spec_band(epdata.e20hz,60,200,False,(4,8),(32,48),1000,(500,1500))
        khdataDG40 = tf2.kldiv_spec_band(epdata.e40hz,60,200,False,(1,4),(32,48),1000,(500,1500))
        khdataDG30 = tf2.kldiv_spec_band(epdata.e30hz,60,200,False,(1,4),(32,48),1000,(500,1500))
        khdataDG20 = tf2.kldiv_spec_band(epdata.e20hz,60,200,False,(1,4),(32,48),1000,(500,1500))
